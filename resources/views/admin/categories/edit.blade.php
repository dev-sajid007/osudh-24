            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description', $category->description) }}</textarea>
                </div>
                ...
                <div>
                    <label for="image" class="block text-sm font-medium text-gray-700">
                        {{ $category->image_url ? 'Replace Category Image' : 'Category Image' }}
                    </label>
                    ...
                    <div id="image-preview" class="hidden mt-2 mb-4">
                        ...
                        <p class="text-sm text-gray-500 mt-1">New image preview - Will be uploaded to Cloudinary</p>
                    </div>
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('name').addEventListener('input', function() {
                ...
                // Only update slug if it's currently empty or matches the old slug pattern
