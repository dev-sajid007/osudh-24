...
@section('content')
    <div class="mb-6">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-3xl font-semibold text-gray-900">Edit Role: {{ $role->display_name }}</h1>
                <p class="text-gray-600">Update role permissions and details</p>
            </div>
        </div>
    </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('description') border-red-300 @enderror">{{ old('description', $role->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
